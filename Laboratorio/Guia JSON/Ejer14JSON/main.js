...
class Manejadora {
    static GenerarTabla() {
        let conexion2 = new XMLHttpRequest();
        let remeras;
        let tabla = "<table border='1'><tr><th>ID</th><th>SLOGAN</th><th>SIZE</th><th>PRICE</th><th>COLOR</th><th>MAN.NAME</th><th>MAN.LOGO</th><th>MAN.LOC.COUNTRY</th><th>MAN.LOC.CITY</th><th>ACCION</th></tr>";
    ...
    static FiltrarPorCampo() {
        let conexion2 = new XMLHttpRequest();
        let remeras;
        let filtro = document.getElementById("filtro").value;
        let campo = document.getElementById("filtrar");
        campo.value = filtro;
        let tabla = "<table border='1'><tr><th>ID</th><th>SLOGAN</th><th>SIZE</th><th>PRICE</th><th>COLOR</th><th>MAN.NAME</th><th>MAN.LOGO</th><th>MAN.LOC.COUNTRY</th><th>MAN.LOC.CITY</th></tr>";
